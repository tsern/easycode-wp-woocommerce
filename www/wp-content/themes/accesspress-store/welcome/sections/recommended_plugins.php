				...
				<div class="recom-plugin-wrap">
					...
					<div class="plugin-title-install clearfix">
						...
						<span class="plugin-btn-wrapper plugin-card-<?php echo esc_attr($plugin['slug']); ?>">
							<a class="<?php echo esc_attr($btn_class); ?>" data-file="<?php echo esc_attr($plugin['slug']).'/'.esc_attr($plugin['filename']); ?>" data-slug="<?php echo esc_attr($plugin['slug']); ?>" href="<?php echo esc_html($link); ?>"><?php echo wp_kses_post($label); ?></a>
						</span>
					</div>
				</div>
			<?php
